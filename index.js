    ...
    if (symbol === 1890) {
      characters.push(
        new Character({
          ...
          scale: 1,
          animate: true,
          dialogue: ["Hello..Good morning, haven't seen you before are you new to this town....","By the way I am Nishant, Have you seen Kaustubh?","I want him to work on my Machine Learning project....", 'His knowledge of TensorFlow and Scikit-learn helps a lot during projects....']
        })
      )
    }
    // 5336 === bob
      ...
      characters.push(
        new Character({
          ...
          scale: 1,
          animate: true,
          dialogue: ["There is lot's of cool blogs written by Kaustubh, you must check out!",' Why Sun never set here..$#@%@#%@%..',"I am feeling sleepy zzzzzzzzzzz"]
        })
      )
    }
//5339==amelia
      ...
      characters.push(
        new Character({
          ...
          scale: 1,
          animate: true,
          dialogue: ['Hello, I am Neha... are you new to this town??','You must visit the portal & explore the town......','I am currently trying to follow Kaustubh on Linkedin & Twitter...' ]
        })
      )
    }
//4527==alex
      ...
      characters.push(
        new Character({
          ...
          scale: 1,
          animate: true,
          dialogue: ['This is the coolest place I have ever visited....',"Have you listen this new music %#@@#$%% by Arjit Singh...... He is amazing!"]
        })
      )
    }
//4519==adam
      ...
      characters.push(
        new Character({
          ...
          scale: 1,
          animate: true,
          dialogue: ['Are you a friend of Kaustubh? I am unable to find him, he is always busy....can you help me??',"We have decided together to work on a Quantum Computing project $ $ $"]
        })
      )
    }
